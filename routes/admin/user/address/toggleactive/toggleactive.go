...
func (r *Route) Handle(context contexts.Context) {
	if !context.HasUserRightOrForbid("UpdateUserAddress") {
		return
	}
	...
	if err := r.userAddressStore.ToggleActive(strings.Split(ids, ",")); err != nil {
...
func New(regularExpressionsRepository regularexpressions.Repository, userAddressStore address.Store) *Route {
	return &Route{
