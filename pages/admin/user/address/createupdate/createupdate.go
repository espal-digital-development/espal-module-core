...
type Factory interface {
	NewPage(context contexts.Context, userAddress *address.Address, user *user.User, language contexts.Language,
...
func (c *CreateUpdate) NewPage(context contexts.Context, userAddress *address.Address, user *user.User,
